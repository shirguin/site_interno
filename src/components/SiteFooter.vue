<template>
    <footer class="footer center">
        ...
        <div class="footer__center">
            ...
            <nav class="footer__center__nav">
                <router-link class="footer__center__nav__link" to="/">Home</router-link>
                <router-link class="footer__center__nav__link" to="/project">Project</router-link>
                <router-link class="footer__center__nav__link" to="/blog">Blog</router-link>
            </nav>
        </div>
        ...
        <div class="footer__right">
            ...
            <div class="footer__right__content">
                <p class="footer__right__content__item">
                    55 East Birchwood Ave. Brooklyn, New York 11201
                </p>
                <p class="footer__right__content__item">contact@interno.com</p>
                <p class="footer__right__content__item">(123) 456 - 7890</p>
            </div>
        </div>
    </footer>
</template>
