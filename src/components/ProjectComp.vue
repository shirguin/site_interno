<template>
    <div class="project">
        <img @click="changeLike(project.id)" class="project__img" :src="require(`@/assets/${project.imgSrc}`)"
            alt="project.imgAlt">
        <svg class="project__img__like" v-if="project.isliked" width="36" height="35" viewBox="0 0 36 35" fill="none"
        ...
        <div class="project__content">
            <div class="project__content__left">
                <h2 class="project__content__left__title">{{ project.title }}</h2>
                <h3 class="project__content__left__nav">Decor / Artchitecture</h3>
            </div>
            <router-link class="project__content__link" to="/project/details">
